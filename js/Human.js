...
var Human = function (z,age) {
    ...
    var bodies = [50, 60, 70, 80, 90, 100];
  

	this.bones = {
	    body : new Human.bone( 0,0,z,   bodies[age],20,36 ),
	    neck : new Human.bone( 0,0,z,   25,10,10 ),
	    head : new Human.bone( 0,0,z    ),
            
	    LeftUpLeg : new Human.bone(   -1000,200,z-10, 50, 15, 15 ),
	    LeftLowLeg : new Human.bone(  0,0,z-10,     60,10,10 ), 
	    RightUpLeg : new Human.bone(  -1000,200,z+10,   50, 15, 15),
	    RightLowLeg : new Human.bone( 0,0,z+10,      60,10,10 ),
	    
	    LeftUpArm : new Human.bone(   0,0,z-22,      40,10,10 ),
	    LeftLowArm : new Human.bone(  0,0,z-22,      50,7,7   ),
	    RightUpArm : new Human.bone(  0,0,z+22,       40,10,10 ),
	    RightLowArm : new Human.bone( 0,0,z+22,       50,7,7   )
	};
...
Human.prototype = {
	...
	initWalk : function (speed) {
		this.running = false;
		this.sets.speed = speed;
	...
	checkWalls : function () {
		if ( this.bones.LeftUpLeg.x >= this.zw ) {
			this.bones.LeftUpLeg.x = -1000;
			this.bones.RightUpLeg.x = -1000;
			this.bones.LeftLowLeg.x = -1000;
			this.bones.RightLowLeg.x = -1000;
		}
	}
};
